        ...
        <div class="page-toolbar" style="display: flex; gap: 1rem; margin-bottom: 2rem; flex-wrap: wrap; align-items: center; background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
          <div class="toolbar-left" style="display: flex; gap: 1rem; flex: 1; flex-wrap: wrap; align-items: center;">
            <div class="search-wrapper" style="flex: 1; min-width: 250px; position: relative;">
              ...
              <input type="text" id="reservationSearch" placeholder="Search by name, phone, email..." style="width: 100%; padding: 0.875rem 1rem 0.875rem 2.75rem; border: 2px solid #e5e7eb; border-radius: 10px; font-size: 0.95rem; transition: all 0.2s; outline: none;" onfocus="this.style.borderColor='var(--primary-red)'; this.style.boxShadow='0 0 0 3px rgba(247,0,0,0.1)'" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none'; this.style.outline='none';">
            </div>
            <div style="display: flex; gap: 0.75rem; align-items: center; background: #f9fafb; padding: 0.5rem; border-radius: 10px; border: 1px solid #e5e7eb;">
              <div style="position: relative;">
                <input type="date" id="reservationDateFrom" style="padding: 0.875rem 2.5rem 0.875rem 1rem; border: 2px solid #e5e7eb; border-radius: 8px; min-width: 160px; font-size: 0.95rem; background: white; cursor: pointer; transition: all 0.2s; outline: none;" onfocus="this.style.borderColor='var(--primary-red)'; this.style.boxShadow='0 0 0 3px rgba(247,0,0,0.1)'" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none'; this.style.outline='none';" onchange="this.blur();">
              ...
              <div style="position: relative;">
                <input type="date" id="reservationDateTo" style="padding: 0.875rem 2.5rem 0.875rem 1rem; border: 2px solid #e5e7eb; border-radius: 8px; min-width: 160px; font-size: 0.95rem; background: white; cursor: pointer; transition: all 0.2s; outline: none;" onfocus="this.style.borderColor='var(--primary-red)'; this.style.boxShadow='0 0 0 3px rgba(247,0,0,0.1)'" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none'; this.style.outline='none';" onchange="this.blur();">
